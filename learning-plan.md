...
> 基于学员画像（Web3 熟悉、AI 新手、开发方向、~4h/天）
...
## 第二阶段：AI × Web3 Bridge（✅ 已完成 — 2026-05-24）

核心交叉层——怎么让 AI Agent 理解链上状态、调用钱包和合约。

| 顺序 | 章节 | 优先级 | 状态 |
|------|------|--------|------|
| 1 | Chain-aware Context | 高 | ✅ |
| 2 | Web3 Tool Use | 高 | ✅ |
| 3 | Agent Workflow | 高 | ✅ |
| 4 | Agent Wallet | 高 | ✅ |
| 5 | Machine Payment | 中 | ✅ |
| 6 | Settlement & Escrow | 中 | ✅ |
| 7 | Agent Identity | 中 | ✅ |
| 8 | AI Oracle | 中 | ✅ |
| 9 | Verifiable AI | 中 | ✅ |
| 10 | AI Security | 高 | ✅ |
| 11 | AI Privacy | 低 | ✅ |
| 12 | Decentralized AI | 低 | ✅ |

> 第 1-2 章笔记见 `daily/2026-05-21.md` 和 `daily/2026-05-22.md`，第 3-12 章为快速阅读通过，
> Phase 2 总结见 `daily/2026-05-25.md`
...
- 每天 ~4h，其中 2h 读 Handbook + 笔记，2h 实验/代码
- 每完成一个章节在 `daily/` 留笔记
- 每周末整理 Handbook feedback
